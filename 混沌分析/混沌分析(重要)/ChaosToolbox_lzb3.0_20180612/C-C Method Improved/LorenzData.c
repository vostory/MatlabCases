...
#define SIGMA prhs[3]       // Lorenz方程参数1
#define R prhs[4]           // Lorenz方程参数2
#define B prhs[5]           // Lorenz方程参数3
			 ...
			 int nrhs, const mxArray *prhs[])	// 输入参数个数，及输入参数数组
{
    ...
    LORENZ_DATA(y,h,k,sigma,r,b,pz);    // y是一维数组的实参
	return;
}

//---------------------------------------------------------------------------
// 定义 C 运算函数
void LORENZ_DATA( double y[],           // y[]是一维数组的形参
                  double h,
                  int k,
                  double sigma,
                  double r,
